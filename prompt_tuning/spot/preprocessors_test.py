...
class PreprocessorsTest(tf.test.TestCase):
  ...
  def test_process_text_classification_single_text(self):
    ...
    dataset = spot_preprocessors.process_text_classification(
        original_dataset,
        text_a_key='sentence',
        task_name='sst2',
  ...
  def test_process_text_classification_text_pair(self):
