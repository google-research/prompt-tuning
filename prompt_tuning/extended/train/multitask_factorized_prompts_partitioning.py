...
"""Custom, default partitioning rules for multitask factorized prompt based models."""
...
def standard_logical_axis_rules() -> partitioning.LogicalAxisRules:
  ...
  return tuple(
      itertools.chain(pt_partitioning.standard_logical_axis_rules(),
                      (("langs", None), ("tasks", None),
                       ("prompt+embed", None))))
