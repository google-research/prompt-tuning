...
"""Tests for multitask factorized prompts."""

from unittest import mock
from absl.testing import absltest
import jax.numpy as jnp
from prompt_tuning import test_utils
from prompt_tuning.extended.train import multitask_factorized_prompts as train_mfp
from prompt_tuning.train import prompts as train_prompts


class PromptsTest(absltest.TestCase):

  def test_multitask_factorized_prompt_does_concatenation(self):
    embed_size = 20
    prompt_length = 5
    batch_size = 2
    seq_len = 20
    ...
    prompt_module = train_mfp.MultiTaskPrompt(
    ...
    mock_combine.assert_called_once_with(
        ...
        test_utils.ArrayAllCloseMatcher(embed[:, 2:]),
        test_utils.ArrayEqualMatcher(input_tokens))
